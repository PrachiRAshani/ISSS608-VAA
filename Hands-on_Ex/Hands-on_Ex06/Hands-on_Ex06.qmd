...
pacman::p_load(scales, viridis, lubridate, ggthemes, gridExtra, CGPfunctions, ggHoriPlot, tidyverse, readxl, knitr, data.table)
```
...
rice %>% 
  ...
  newggslopegraph(Year, Yield, Country,
                ...
                SubTitle = "1961-1980",
                Caption = "Prepared by: Prachi Ashani under the guidance of Dr. Kam Tin Seong")
```
