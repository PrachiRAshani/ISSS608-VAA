...
To start using **ggplot2** and **tidyverse** packages for analysis and visualization, we load the libraries using the pacman package and p_load function in R Studio.
...
pp <- ggplot(data = data_top9, aes(x = Age_groups, y = Population, fill = Sex)) +
  ...
  theme(plot.margin = margin(t=0.1, r=0.1, b=0.1, l=0.1),
